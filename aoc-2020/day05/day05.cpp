 ...
 *
 */
void day05::print_element_pp_list(void) {
  int current_index = 0;
 ...
 * @param element_pos
 */
void day05::init_element_pp_list(int element_pos) {
 ...
 */
void day05::set_value_pp_list(int element_pos, std::string element_name,
 ...
 */
bool day05::check_single_policy_p1(passport_type pp_element) {
 ...
 */
bool day05::check_single_policy_p2(passport_type pp_element) {
  bool is_password_valid = false;
 ...
 */
int day05::count_valid_policies_p1(void) {
 ...
 * @return int number of valid passwords
 */
int day05::count_valid_policies_p2(void) {
  bool policy_valid = false;
 ...
 * @return false
 */
bool day05::value_check_byr(std::string value) {
 ...
 * @return false
 */
bool day05::value_check_iyr(std::string value) {
  bool policy_result = false;
  if (value != "") {
    int value_num = stoi(value);
    int value_digits = 4;
 ...
 * @return false
 */
bool day05::value_check_eyr(std::string value) {
  bool policy_result = false;
  if (value != "") {
    int value_num = stoi(value);
    int value_digits = 4;
 ...
 * @return false
 */
bool day05::value_check_hgt(std::string value) {
  bool policy_result = false;
  if (value != "") {
 ...
 * @return false
 */
bool day05::value_check_hcl(std::string value) {
  bool policy_result = false;
  if (value != "") {
    int value_digits = 7;
 ...
 * @return false
 */
bool day05::value_check_ecl(std::string value) {
  bool policy_result = false;
  if (value != "") {
 ...
 * @return false
 */
bool day05::value_check_pid(std::string value) {
  bool policy_result = false;
  if (value != "") {
    int value_digits = 9;
 ...
 * @return false
 */
bool day05::value_check_cid(std::string value) {
  bool policy_result = false;
  int value_num = stoi(value);
  int value_digits = 4;
  const int value_min = 1920;
